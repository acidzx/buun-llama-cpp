...
typedef enum { ncclChar       = 0,
               ...
               ncclFloat8_e4m3fn  = 9,
               ncclFloat8_e5m2    = 10,
               nccl_NUM_TYPES = 11 } ncclDataType_t;
...
/* Group start/end for batching NCCL calls */
NCCL_EXPORTED ncclResult_t  ncclGroupStart(void);
ncclResult_t pncclGroupStart(void);

NCCL_EXPORTED ncclResult_t  ncclGroupEnd(void);
